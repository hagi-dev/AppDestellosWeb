            <div class="containerCarta__title">
                <h2 id="titulo-pagina"><?php echo $nameTitle ?></h2>
                    <div class="containerCarta__title-carrito" id="carritoCompras">
                        <a href="./carrito.php">
                ...
                <div class="path"><p id="path">path</p></div>
            </div>
