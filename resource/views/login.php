<?php
    ...
    require_once ("../object/SesionLogin.php");

    
    $page = isset($_GET["page"])?$_GET["page"]:null;
    $estado= isset($_GET["estado"])? $_GET["estado"]:null;
    
    $objeto1= new SesionLogin();
    $objeto2= new Login();
    ...
    case "login":
        ...
        if($res==0){
            ...
            $objeto1-> setSesion('nombre',$res['CUS_name'],$res['CUS_id']);
    ...
    <main>
        <div class="login">
            <div class="login__imagen">
                <img src="https://i.ibb.co/Kq2sp5m/logo8.png" alt="">
            </div>
