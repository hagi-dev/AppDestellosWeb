...
<?php $title="menu/pollos y parrillas" ?>
<?php $carritoHover="../../public_html/js/hoverCarrito.js" ?>
<?php $nameTitle="Pollos y parrillas con sabor..." ?>
...
<?php include("../templates/header.php") ?> 
        <div class="containerMenuPollosParrillas">
                <?php include ( __DIR__.'/../templates/titleCarrito.php')?>
